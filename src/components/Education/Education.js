      ...
      <Container>
        ...
        {/* <Col md={4} className="education-card">
          <EducationCards
            imgPath={bitsOfCode}
            isBlog={false}
            title={<h1><strong className="main-name"> SSC</strong></h1>}
            description={<h2>De Paul English Medium High School 10th SSC Board June 2006- April 2016</h2>}
          />
        </Col> */}
...
// import EducationCard from "./EducationCard.scss";
